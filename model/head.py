...
class SelfAttentionHead(nn.Module):
    ...
    def __init__(self, input_size: int, head_size: int, dropout: float = 0.2):
        ...
        self.query_proj = nn.Linear(input_dims=input_size, output_dims=head_size, bias=False)
        self.keys_proj = nn.Linear(input_dims=input_size, output_dims=head_size, bias=False)
        self.values_proj = nn.Linear(input_dims=input_size, output_dims=head_size, bias=False)
